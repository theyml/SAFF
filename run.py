...
def get_basic_parser(
    ...
    parser.add_argument('--scaler_mode', type=str, default='window', choices=['window', 'global'],
        help='scaling mode: window fits a scaler per sample window; global fits one scaler on the train split and reuses it for train/val/test')
